...
/// @nodoc
abstract class _$$_SearchResponseItemCopyWith<$Res>
    implements $SearchResponseItemCopyWith<$Res> {
  factory _$$_SearchResponseItemCopyWith(_$_SearchResponseItem value,
          $Res Function(_$_SearchResponseItem) then) =
      __$$_SearchResponseItemCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int id,
...
/// @nodoc
class __$$_SearchResponseItemCopyWithImpl<$Res>
    extends _$SearchResponseItemCopyWithImpl<$Res, _$_SearchResponseItem>
    implements _$$_SearchResponseItemCopyWith<$Res> {
  __$$_SearchResponseItemCopyWithImpl(
      _$_SearchResponseItem _value, $Res Function(_$_SearchResponseItem) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SearchResponseItem(
      id: null == id
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as int,
...
/// @nodoc
@JsonSerializable()
class _$_SearchResponseItem implements _SearchResponseItem {
  const _$_SearchResponseItem(
      {required this.id,
  ...
  factory _$_SearchResponseItem.fromJson(Map<String, dynamic> json) =>
      _$$_SearchResponseItemFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SearchResponseItem &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SearchResponseItemCopyWith<_$_SearchResponseItem> get copyWith =>
      __$$_SearchResponseItemCopyWithImpl<_$_SearchResponseItem>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SearchResponseItemToJson(
      this,
    );
  }
}
...
abstract class _SearchResponseItem implements SearchResponseItem {
  const factory _SearchResponseItem(
      ...
      required final List<String> topics}) = _$_SearchResponseItem;

  factory _SearchResponseItem.fromJson(Map<String, dynamic> json) =
      _$_SearchResponseItem.fromJson;
