...
/// @nodoc
abstract class _$$_SearchResponseLicenseCopyWith<$Res>
    implements $SearchResponseLicenseCopyWith<$Res> {
  factory _$$_SearchResponseLicenseCopyWith(_$_SearchResponseLicense value,
          $Res Function(_$_SearchResponseLicense) then) =
      __$$_SearchResponseLicenseCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({String key, String name, String? spdxId, String? url});
}
...
/// @nodoc
class __$$_SearchResponseLicenseCopyWithImpl<$Res>
    extends _$SearchResponseLicenseCopyWithImpl<$Res, _$_SearchResponseLicense>
    implements _$$_SearchResponseLicenseCopyWith<$Res> {
  __$$_SearchResponseLicenseCopyWithImpl(_$_SearchResponseLicense _value,
      $Res Function(_$_SearchResponseLicense) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SearchResponseLicense(
      key: null == key
          ? _value.key
          : key // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_SearchResponseLicense implements _SearchResponseLicense {
  const _$_SearchResponseLicense(
      {required this.key,
      required this.name,
      required this.spdxId,
      required this.url});

  factory _$_SearchResponseLicense.fromJson(Map<String, dynamic> json) =>
      _$$_SearchResponseLicenseFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SearchResponseLicense &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SearchResponseLicenseCopyWith<_$_SearchResponseLicense> get copyWith =>
      __$$_SearchResponseLicenseCopyWithImpl<_$_SearchResponseLicense>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SearchResponseLicenseToJson(
      this,
    );
  }
}
...
abstract class _SearchResponseLicense implements SearchResponseLicense {
  const factory _SearchResponseLicense(
      ...
      required final String? url}) = _$_SearchResponseLicense;

  factory _SearchResponseLicense.fromJson(Map<String, dynamic> json) =
      _$_SearchResponseLicense.fromJson;
