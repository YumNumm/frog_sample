...
/// @nodoc
abstract class _$$_SearchResponseOwnerCopyWith<$Res>
    implements $SearchResponseOwnerCopyWith<$Res> {
  factory _$$_SearchResponseOwnerCopyWith(_$_SearchResponseOwner value,
          $Res Function(_$_SearchResponseOwner) then) =
      __$$_SearchResponseOwnerCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String login,
...
/// @nodoc
class __$$_SearchResponseOwnerCopyWithImpl<$Res>
    extends _$SearchResponseOwnerCopyWithImpl<$Res, _$_SearchResponseOwner>
    implements _$$_SearchResponseOwnerCopyWith<$Res> {
  __$$_SearchResponseOwnerCopyWithImpl(_$_SearchResponseOwner _value,
      $Res Function(_$_SearchResponseOwner) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_SearchResponseOwner(
      login: null == login
          ? _value.login
          : login // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_SearchResponseOwner implements _SearchResponseOwner {
  const _$_SearchResponseOwner(
      {required this.login,
      required this.id,
  ...
  factory _$_SearchResponseOwner.fromJson(Map<String, dynamic> json) =>
      _$$_SearchResponseOwnerFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SearchResponseOwner &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_SearchResponseOwnerCopyWith<_$_SearchResponseOwner> get copyWith =>
      __$$_SearchResponseOwnerCopyWithImpl<_$_SearchResponseOwner>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SearchResponseOwnerToJson(
      this,
    );
  }
}
...
abstract class _SearchResponseOwner implements SearchResponseOwner {
  const factory _SearchResponseOwner(
      ...
      required final String htmlUrl}) = _$_SearchResponseOwner;

  factory _SearchResponseOwner.fromJson(Map<String, dynamic> json) =
      _$_SearchResponseOwner.fromJson;
